...
*   2. Working and it would seen writing good JSON
*   3. Difference programatically between -000.js and -001.js is
*       the use of fs.readFileSync() so that we don't have to 
*       do everything in the callback
*
*  Now add the key field so that we can use .map() to create JSX list(s)
*
*/
...
// });
// ... but this works fine bcs it's synchrnous so it returns a value [https://stackoverflow.com/questions/10058814/get-data-from-fs-readfile]
